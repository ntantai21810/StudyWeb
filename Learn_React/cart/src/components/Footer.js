    ...
    return (
      <footer className="page-footer center-on-small-only">
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-lg-2">
              ...
              <ul>
                <li>
                  <a href="https://www.google.com/">Store Delivery</a>
                </li>
                <li>
                  <a href="https://www.google.com/">Online Delivery</a>
                </li>
                <li>
                ...
                <li>
                  <a href="https://www.google.com/">Tracking</a>
                </li>
              </ul>
            </div>
            <div className="col-lg-2">
              ...
              <ul>
                ...
                <li>
                  <a href="https://www.google.com/">Return Policy</a>
                </li>
                <li>
                  <a href="https://www.google.com/">Product Registration</a>
                </li>
              </ul>
            </div>
        ...
        <div className="footer-copyright">
          <div className="container-fluid">
            © 2016 Copyright:
            <a href="https://www.google.com/ttp://www.MDBootstrap.com">
              {" "}
              MDBootstrap.com{" "}
            </a>
          </div>
